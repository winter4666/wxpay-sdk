...
public class WXPay {
    ...
    public Map<String, String> transfers(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url;
        if (this.useSandbox) {
            throw new RuntimeException("transfers is not supported in sandbox");
        }
        else {
     ...
     * @return
     */
    public String decryptRefundReqInfo(String reqInfo) {
		try {
			...
			throw new RuntimeException("decryptRefundReqInfo error", e);
		}
    }
